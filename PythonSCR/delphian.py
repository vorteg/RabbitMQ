...
def LoadCryptoKeysFromDatabase():
    ...
    #conn = pyodbc.connect(r'DRIVER=ODBC Driver 17 for SQL Server; SERVER=vfc5ury0de.database.windows.net;  DATABASE=SecuRemote-Retail-P1; UID=srretailprod; PWD=!c$!HxJB/V>3]S5H;')
...
def OnMessage(client, userdata, message):
    ...
    if (bridge in userdata):
        try:
            ...
            #print(str(message.topic) + str(msg.decode('ascii')))
            #print(d)
            #print(message.topic + ":" + msg.decode('ascii'), extra={"tags":{"bridge": bridge }})
